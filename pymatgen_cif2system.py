...
def cif_read_pymatgen(filename, charges=False, coplanarity_tolerance=0.1):
    ...
    valencies = { 'H':1.0, 
                 'Li':1.0, 'Be':2.0,  'B':3.0,  'C':4.0,  'N':3.0,  'O':2.0,  'F':1.0,
                 'Na':1.0, 'Mg':2.0, 'Al':3.0, 'Si':4.0,  'P':3.0,  'S':2.0, 'Cl':1.0,
                  'K':1.0, 'Ca':2.0, 'Ga':3.0, 'Ge':4.0, 'As':3.0, 'Se':2.0, 'Br':1.0,
                 'Rb':1.0, 'Sr':2.0, 'In':3.0, 'Sn':4.0, 'Sb':3.0, 'Te':2.0,  'I':1.0,
                  'X':1.0}
